...
function App() {
  ...
  return (
    <div className="background">
      <div className="box">
        {/* city search form */}
        <form autoComplete="on" onSubmit={handleCitySearch}>
          <label>
                          ...
                          <div className="metrices">
                            ...
                            <div className="key-value-box">
                              ...
                              <div className="value">
                                ...
                                {/* Display wind direction in degrees and compass direction */}
                                <span> | {citySearchData.data.wind.deg}&deg; {degreesToCompass(citySearchData.data.wind.deg)}</span>
                              </div>
                            </div>
